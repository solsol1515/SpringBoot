...
public class BoardController {
   ...
   public void getBoardList(Model m) {
	...
	public String deleteBoard(BoardVO vo) {
		...
		System.out.println("[Controller : deleteBoard 요청] 글 삭제: " + vo.getSeq());
	...
	public String saveBoard(BoardVO vo) {
		...
		System.out.println("[Controller : saveBoard 요청] 새 글 저장 : "+vo.getTitle());
		return "redirect:getBoardList"; 
	}
	...
	public String updateBoard(BoardVO vo) {
		...
		System.out.println("[Controller : updateBoard 요청] 글 수정 : " + vo.getTitle());
		return "redirect:getBoardList";
	}
